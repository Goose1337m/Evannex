call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\jtacsettings.sqf";
call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\Attacks\Projectiles.sqf";
call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\Attacks\EvenSpread.sqf";
call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\Attacks\Mines.sqf";
call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\Attacks\Bombs.sqf";
call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\Attacks\Rockets.sqf";
call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\Attacks\GuidedMissile.sqf";
call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\Attacks\StrafingRun.sqf";
call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\jtacattackparser.sqf";
call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\jtacfirecontrol.sqf";
call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\jtacreload.sqf";
call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\jtacmapcontrol.sqf";
...
if(!isDedicated) then {
	...
	if (player getVariable ["JTAC", false]) then {
		...
		call compile preprocessFileLineNumbers "Scripts\EPD\VirtualJTAC\jtacdoc.sqf";
	};
