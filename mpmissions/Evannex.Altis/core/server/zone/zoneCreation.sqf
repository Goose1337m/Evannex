...
br_garbage_collection_positions_interval = 1620; // Delete certain AI if they have not moved within this time or too far from the zone
...
br_custom_units_chosen_offset = 0.3; // Chance of custom groups chosen overall
...
br_fnc_get_faction = {
	...
	private _faction = "";
	switch (_index) do {
		case 0: { _faction = "A3_AAF" };
		case 1: { _faction = "A3_CSAT_Arid" };
		case 2: { _faction = "A3_CSAT_Spetsnaz" };
		case 3: { _faction = "A3_CSAT_Tropic" };
		case 4: { _faction = "A3_FIA" };
		case 5: { _faction = "A3_LDF" };
		case 6: { _faction = "A3_NATO_Arid" };
		case 7: { _faction = "A3_NATO_Tropic" };
		case 8: { _faction = "A3_NATO_Woodland" };
		case 9: { _faction = "A3_Syndikat" };
		case 10: { _faction = "CSLA_AFMC" };
		case 11: { _faction = "CSLA_CSLA" };
		case 12: { _faction = "CSLA_FIA" };
		case 13: { _faction = "CSLA_US" };
		case 14: { _faction = "CUP_CDF" };
		case 15: { _faction = "CUP_RACS" };
		case 16: { _faction = "CUP_RUS_Arid" };
		case 17: { _faction = "CUP_RUS_Woodland" };
		case 18: { _faction = "CUP_SLA" };
		case 19: { _faction = "CUP_Takistan" };
		case 20: { _faction = "CUP_US_Arid" };
		case 21: { _faction = "CUP_US_Woodland" };
		case 22: { _faction = "FFAA" };
		case 23: { _faction = "GMX_AAF" };
		case 24: { _faction = "GMX_CDF" };
		case 25: { _faction = "GMX_CDF2020" };
		case 26: { _faction = "GMX_ChDkZ" };
		case 27: { _faction = "GMX_Takistan" };
		case 28: { _faction = "GM_Bundeswehr_Arid" };
		case 29: { _faction = "GM_Bundeswehr_Winter" };
		case 30: { _faction = "GM_Bundeswehr_Woodland" };
		case 31: { _faction = "GM_Denmark_Arid" };
		case 32: { _faction = "GM_Denmark_Winter" };
		case 33: { _faction = "GM_Denmark_Woodland" };
		case 34: { _faction = "GM_NVA_Arid" };
		case 35: { _faction = "GM_NVA_Winter" };
		case 36: { _faction = "GM_NVA_Woodland" };
		case 37: { _faction = "GM_POL_Arid" };
		case 38: { _faction = "GM_POL_Winter" };
		case 39: { _faction = "GM_POL_Woodland" };
		case 40: { _faction = "GM_Revolutionaries_Arid" };
		case 41: { _faction = "GM_Revolutionaries_Winter" };
		case 42: { _faction = "GM_Revolutionaries_Woodland" };
		case 43: { _faction = "RHSAFRF_Arid" };
		case 44: { _faction = "RHSAFRF_Woodland" };
		case 45: { _faction = "RHSGREF" };
		case 46: { _faction = "RHSSAF" };
		case 47: { _faction = "RHSUSAF_Arid" };
		case 48: { _faction = "RHSUSAF_Woodland" };
		case 49: { _faction = "RHS_UA_UAF" };
		case 50: { _faction = "SOGPF_ARVN" };
		case 51: { _faction = "SOGPF_FANK" };
		case 52: { _faction = "SOGPF_Khmer_Rouge" };
		case 53: { _faction = "SOGPF_MACV" };
		case 54: { _faction = "SOGPF_PathetLao" };		
		case 55: { _faction = "SOGPF_PAVN" };
		case 56: { _faction = "SOGPF_USMC" };
		case 57: { _faction = "SOGPF_Viet_Cong" };
		case 58: { _faction = "Western_Sahara_ION" };
		case 59: { _faction = "Western_Sahara_NATO" };
		case 60: { _faction = "Western_Sahara_SFIA" };
		case 61: { _faction = "Western_Sahara_Tura" };
		case 62: { _faction = "Western_Sahara_UNA" };
		case 63: { _faction = "WW2_Spearhead_French_Interior_Forces" };
		case 64: { _faction = "WW2_Spearhead_French_Liberation_Army" };
		case 65: { _faction = "WW2_Spearhead_Stormtroopers" };
		case 66: { _faction = "WW2_Spearhead_US_Army" };
		case 67: { _faction = "WW2_Spearhead_Wehrmacht" };
